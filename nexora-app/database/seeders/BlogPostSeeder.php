    ...
    public function run(): void
    {
        $posts = [
            [
                ...
                'title' => 'Nexora запускает обновлённый сайт студии',
                'kind' => BlogPost::KIND_NEWS,
                'excerpt' => 'Представили новый сайт с портфолио, тарифами и улучшенной SEO-структурой.',
                'content' => "Мы обновили публичную часть Nexora: теперь клиенты могут смотреть кейсы, изучать тарифы и оставлять заявку в несколько кликов.\n\nСайт собран на Laravel + Vue и управляется через Nova — контент можно менять без правок в коде.",
                'author' => 'Команда Nexora',

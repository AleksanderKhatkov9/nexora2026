...
@section('meta_description', 'На сервере произошла ошибка. Я уже работаю над её устранением.')
        ...
        <div class="landing-container error-page__inner">
            ...
            <div class="error-page__card">
                ...
                <p class="error-page__text">
                    На моей стороне произошёл сбой. Попробуйте обновить страницу через минуту
                    или вернитесь на главную — я уже разбираюсь с проблемой.
                </p>
                ...
                <p class="error-page__hint">
                    Если ошибка повторяется, напишите мне через форму на главной — укажите время и адрес страницы.
                </p>
            </div>
        </div>
    </section>
